...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split='training'):
        ...
        # lidar 4 beams
        # self.lidar_dir = "/media/zelt/Données/KITTI/3D_OD/training/velodyne_4beams_from_pseudolidarplusplus_7481"
        # self.lidar_dir =  os.path.join("/home/zelt/PHD_1st_project/src/dataset/pseudo/pseudo-lidar_velodyne")
        # test for pseudo-lidar
        # self.pseudo_lidar_dir = os.path.join("/home/zelt/PHD_1st_project/src/dataset/pseudo/pseudo-lidar_velodyne")
...
def show_lidar_with_boxes0(pc_velo, objects, calib,
                          img_fov=False, img_width=None, img_height=None, colors=(0.5, 0.5, 0.5)):
    """
    ...
    if img_fov:  # filter lidar pcl, keep those in fov
    ...
    for obj in objects:
        ...
        # calculate 3d bb in rect cam coord
        box3d_pts_2d, box3d_pts_3d = utils.compute_box_3d(obj, calib.P)
        # project 3d bb in rect cam coord into velo coord
        box3d_pts_3d_velo = calib.project_rect_to_velo(box3d_pts_3d)
        ...
        # draw the arrows show the direction
        x1, y1, z1 = ori3d_pts_3d_velo[0, :]
        x2, y2, z2 = ori3d_pts_3d_velo[1, :]
        mlab.plot3d([x1, x2], [y1, y2], [z1, z2], color=colors,
...
def show_lidar_with_boxes(
    ...
    # if pseudo_lidar!=None:
    # draw_lidar(pseudo_lidar, fig=fig, pts_color=(0,0,1))
    # pc_velo=pc_velo[:,0:3]
    ...
    if objects_pred is not None:
        ...
        for obj in objects_pred:
            ...
            for car_truth in car_obj:
                ...
                print("-------------------obj 4: {} ------IoU3D: {}".format(obj.xmax, iou3d(car_truth, box3d_pts_3d)[0]))
    ...
    # mlab.savefig(filename='/home/zelt/Desktop/test.png')
    """
    mlab.show()
