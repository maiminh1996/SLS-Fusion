...
# parser.add_argument('--gt_depthmap_path1', type=str,
#                     help='path to groundtruth depthmap')
# parser.add_argument('--gt_depthmap_path2', type=str,
#                     help='path to groundtruth depthmap')
...
def main(args):
    ...
    if args.threads <= 1:
        ...
        for idx in idx_list:
            ...
            # predict = np.load(osp.join(args.input_path, "image_2_{:06d}.npy".format(idx)))
            predict = np.load(osp.join(args.input_path, "{:06d}.npy".format(idx)))
            gt = load_lidar_bin(osp.join(args.gt_depthmap_path, "{:06d}.png".format(idx)))
