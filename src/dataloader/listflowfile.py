...
def dataloader(filepath):
    filepath += '/'  # /home/zelt/Pseudo_Lidar_V2/sceneflow/
    print("####")
    print("os.listdir(filepath): ", os.listdir(filepath))
    print("os.path.isdir(os.path.join(filepath, d)): ", os.path.isdir(os.path.join(filepath, os.listdir(filepath)[0])))

    classes = [d for d in os.listdir(filepath) if
               os.path.isdir(os.path.join(filepath, d))]  # ['driving', 'flyingthings3d', 'monkaa']

    # classes = [filepath + d for d in os.listdir(filepath) if os.path.isdir(os.path.join(filepath, d))]
    # image = [img for img in classes if img.find('frames_cleanpass') > -1] # luu cac thu m
    image = [img for img in classes if img.find('cleanpass') > -1]  # luu cac thu m
    ...
    # monkaa_path = '/home/zelt/Pseudo_Lidar_V2/sceneflow/monkaa_cleanpass'
    monkaa_dir = os.listdir(monkaa_path)

    # print(monkaa_dir)
    # monkaa_path = '/home/zelt/Pseudo_Lidar_V2/sceneflow/monkaa'
    # monkaa_dir = os.listdir(monkaa_path)
    ...
    flying_path = filepath + [x for x in image if x == 'flyingthings3d_cleanpass'][0]
